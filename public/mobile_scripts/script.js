...
//menu open and close function
	...
	$('.button--navigation').on('click',function(){
		...
		//fade in Rise logo
			...
			$('.holder--navigation').css('background','rgba(0,0,0,0.4)');
	...
	//function to change background to match selected thumbnail 

	$('.images').on('click',function(){
		var newBackground = $(this).data('color');
		console.log('test');
		$('.holder--navigation').css({'background': newBackground});
	});
